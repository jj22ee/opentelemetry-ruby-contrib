...
OpenTelemetry.tracer_provider.sampler = OpenTelemetry::Sampler::XRay::InternalAwsXRayRemoteSampler.new(polling_interval:11, resource:OpenTelemetry::SDK::Resources::Resource.create({"service.name"=>"manual"}))
# OpenTelemetry.tracer_provider.sampler = OpenTelemetry::SDK::Trace::Samplers::ALWAYS_ON # CustomSampler.new(sampling_probability)